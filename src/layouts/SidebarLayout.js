      ...
      <Link href={isPublished ? href : fallbackHref}>
        <a
          className={clsx('block border-l pl-4 -ml-px', {
            'text-teal-500 border-current font-semibold dark:text-teal-400': isActive,
...
//         className="mb-4"
//         shadow="group-hover:shadow-teal-200 dark:group-hover:bg-teal-500"
//         activeBackground="dark:bg-teal-500"
//         icon={
//           <>
//             <path
//               fillRule="evenodd"
...
//               className={clsx(
//                 'fill-teal-200 group-hover:fill-teal-500',
//                 pathname.startsWith('/docs')
//                   ? 'dark:fill-teal-300 dark:group-hover:fill-teal-300'
//                   : 'dark:fill-slate-400 dark:group-hover:fill-teal-300'
//               )}
//             />
//             <path
//               fillRule="evenodd"
...
//               className={clsx(
//                 'fill-teal-400 group-hover:fill-teal-500',
//                 pathname.startsWith('/docs')
//                   ? 'dark:fill-teal-200 dark:group-hover:fill-teal-200'
//                   : 'dark:fill-slate-600 dark:group-hover:fill-teal-200'
//               )}
//             />
//           </>
//         }
...
//             <path
//               className={clsx(
//                 'fill-teal-200 group-hover:fill-teal-300 dark:group-hover:fill-teal-200',
...
//             <path
//               className={clsx(
//                 'fill-teal-400 group-hover:fill-teal-500 dark:group-hover:fill-teal-300',
...
//         }
//       >
//         <span className="inline-flex items-baseline">Jobs</span>
//       </TopLevelLink>
//     </>
//   )
// }
