...
In v3.0, every single color in the extended color palette is enabled by default, including lime, cyan, teal, fuchsia, rose, and fifty shades of gray.
...
<p>
  ...
  <a href="#" class="underline **decoration-teal-500 decoration-2**">My Company, Inc</a>. Outside of work, I
