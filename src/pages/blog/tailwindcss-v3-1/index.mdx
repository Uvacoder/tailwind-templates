    ...
    <form>
      <div>
        ...
        <div class="mt-1 relative">
          <input required type="text" name="email" id="optional-email" class="peer px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-teal-500 focus:ring-teal-500 block w-full rounded-md sm:text-sm focus:ring-1" />
      ...
      <div class="mt-6">
        ...
        <div class="mt-1 relative">
          <input type="text" name="name" id="optional-name" class="peer px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400  focus:outline-none focus:border-teal-500 focus:ring-teal-500 block w-full rounded-md sm:text-sm focus:ring-1" />
          <div class="peer-optional:hidden absolute inset-y-0 right-0 text-sm pr-3 py-2 border-y border-transparent text-slate-400">
            Required
          </div>
        </div>
