...
Tailwind uses literal color names _(like red, teal, etc.)_ and a numeric scale _(where 50 is light and 900 is dark)_ by default. We think this is the best choice for most projects, and have found it easier to maintain than using abstract names like `primary` or `danger`.
