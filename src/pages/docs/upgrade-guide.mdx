...
In v3.0, these colors use their extended names by default, so what was previously `bg-teal-500` is now `bg-emerald-500`, and `bg-teal-500` now refers to the teal from the extended palette.
