...
<Example>
  <div class="font-mono text-white text-sm font-bold leading-6">
    <div class="flex items-stretch gap-4 w-full rounded-lg bg-stripes-teal h-24">
      <div class="p-4 flex-1 flex items-center justify-center rounded-lg bg-teal-300 dark:bg-teal-800 dark:text-teal-500">01</div>
      <div class="self-auto p-4 flex-1 flex items-center justify-center shadow-lg rounded-lg bg-teal-500">02</div>
      <div class="p-4 flex-1 flex items-center justify-center rounded-lg bg-teal-300 dark:bg-teal-800 dark:text-teal-500">03</div>
    </div>
  </div>
</Example>
