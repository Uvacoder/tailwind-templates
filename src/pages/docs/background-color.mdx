...
<Example>
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 text-sm text-white">
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-slate-500 font-mono text-center mb-3 dark:text-slate-400">bg-teal-500</p>
      <button class="px-4 py-2 font-semibold text-sm bg-teal-500 text-white rounded-md shadow-sm opacity-100">Button A</button>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-slate-500 font-mono text-center mb-3 dark:text-slate-400">bg-teal-500/75</p>
      <button class="px-4 py-2 font-semibold text-sm bg-teal-500/75 text-white rounded-md shadow-sm opacity-100">Button B</button>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-slate-500 font-mono text-center mb-3 dark:text-slate-400">bg-teal-500/50</p>
      <button class="px-4 py-2 font-semibold text-sm bg-teal-500/50 text-white rounded-md shadow-sm opacity-100">Button C</button>
    </div>
  </div>
</Example>

```html
<button class="bg-teal-500**/100** ..."></button>
<button class="bg-teal-500**/75** ..."></button>
<button class="bg-teal-500**/50** ..."></button>
```
...
<BreakpointsAndMediaQueries featuredClass="bg-teal-500">

```html
<button class="bg-blue-500 **md:bg-teal-500** ...">Subscribe</button>
```
