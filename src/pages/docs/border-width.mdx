...
<Example>
  <div class="flex flex-col sm:flex-row items-center justify-around gap-4 text-white text-sm text-center font-bold leading-6">
    <div class="flex flex-col items-center shrink-0">
      ...
      <div class="p-4 shadow-sm bg-white dark:bg-slate-900 w-16 h-16 border-indigo-600 dark:border-teal-500 border"></div>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-slate-500 font-mono text-center mb-3 dark:text-slate-400">border-2</p>
      <div class="p-4 shadow-sm bg-white dark:bg-slate-900 w-16 h-16 border-indigo-600 dark:border-teal-500 border-2"></div>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-slate-500 font-mono text-center mb-3 dark:text-slate-400">border-4</p>
      <div class="p-4 shadow-sm bg-white dark:bg-slate-900 w-16 h-16 border-indigo-600 dark:border-teal-500 border-4"></div>
    </div>
    <div class="flex flex-col items-center shrink-0">
      <p class="font-medium text-sm text-slate-500 font-mono text-center mb-3 dark:text-slate-400">border-8</p>
      <div class="p-4 shadow-sm bg-white dark:bg-slate-900 w-16 h-16 border-indigo-600 dark:border-teal-500 border-8"></div>
    </div>
  </div>
</Example>

```html
<div class="**border** border-indigo-600 ..." dark-class="**border** border-teal-500"></div>
<div class="**border-2** border-indigo-600 ..." dark-class="**border-2** border-teal-500"></div>
<div class="**border-4** border-indigo-600 ..." dark-class="**border-4** border-teal-500"></div>
<div class="**border-8** border-indigo-600 ..." dark-class="**border-8** border-teal-500"></div>
```
