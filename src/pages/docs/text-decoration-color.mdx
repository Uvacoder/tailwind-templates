...
<div>
  <p>
    ...
    <a class="underline **decoration-teal-500**">My Company, Inc</a>.
...
<div>
  <p>
    I’m Derek, an astro-engineer based in Tattooine. I like to build X-Wings at
    <a class="underline **decoration-teal-500/30**">My Company, Inc</a>.
...
```html
<strong class="underline **decoration-teal-500/[.33]**"></strong>
```
...
<HoverFocusAndOtherStates defaultClass="underline decoration-teal-600" featuredClass="decoration-blue-400" element="p" />

### <Heading ignore>Breakpoints and media queries</Heading>

<BreakpointsAndMediaQueries defaultClass="underline decoration-teal-600" featuredClass="decoration-blue-400" element="p" />
