...
<Example>
  <div class="relative text-sm font-medium leading-6">
    <div class="bg-teal-400/20 border border-sky-700/10 rounded-lg p-4 dark:bg-blue-900/70 dark:border-0">
      <div class="relative bg-teal-400/20 border border-sky-700/10 p-4 h-32 dark:bg-blue-400/20 dark:border-0">
