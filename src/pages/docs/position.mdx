...
<Example>
  <div class="relative text-sm font-medium leading-6">
    <div class="bg-purple-400/20 border border-purple-700/10 rounded-lg p-4 dark:bg-teal-900/70 dark:border-0">
      <div class="static bg-purple-400/20 border border-purple-700/10 p-4 h-32 dark:bg-teal-400/20 dark:border-0">
        <p class="text-purple-700 dark:text-teal-200">Static parent</p>
        <div class="absolute bottom-0 left-0 bg-purple-500 shadow-lg rounded-lg p-4 text-white dark:bg-teal-500">
          <p>Absolute child</p>
        </div>
      </div>
    </div>
...
<Example>
  <div class="relative text-sm font-medium leading-6">
    <div class="bg-teal-400/20 border border-teal-700/10 rounded-lg p-4 dark:bg-blue-900/70 dark:border-0">
      <div class="relative bg-teal-400/20 border border-teal-700/10 p-4 h-32 dark:bg-blue-400/20 dark:border-0">
        <p class="text-teal-700 dark:text-white">Relative parent</p>
        <div class="absolute bottom-0 left-0 bg-teal-500 shadow-lg rounded-lg p-4 text-white dark:bg-blue-500">
          <p>Absolute child</p>
        </div>
      </div>
    </div>
