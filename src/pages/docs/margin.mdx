...
<Example>
  <div class="flex justify-center font-mono text-white text-sm font-bold leading-6">
    <div class="flex flex-col items-center">
      <div class="relative w-36 h-16 bg-teal-400/20 border border-teal-700/10 rounded-md overflow-hidden"></div>
      <div class="relative -mt-8 bg-teal-500 rounded-md flex items-center justify-center p-4 shadow-lg">-mt-8</div>
    </div>
  </div>
</Example>

```html
<div class="w-36 h-16 bg-teal-400 opacity-20 ..."></div>
<div class="**-mt-8** bg-teal-300 ...">-mt-8</div>
```
