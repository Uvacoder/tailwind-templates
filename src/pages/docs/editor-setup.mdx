...
```html
<!-- Before -->
<button class="text-white px-4 sm:px-8 py-2 sm:py-3 bg-teal-700 hover:bg-teal-800">...</button>

<!-- After -->
<button class="bg-teal-700 px-4 py-2 text-white hover:bg-teal-800 sm:px-8 sm:py-3">...</button>
```
