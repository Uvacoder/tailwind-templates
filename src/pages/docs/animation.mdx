  ...
  custom: (
    <table className="w-full text-left border-collapse">
      ...
      <tbody className="align-baseline">
        <tr>
          <td translate="no" className="py-2 pr-2 font-mono font-bold text-xs leading-6 text-teal-500 whitespace-nowrap dark:text-teal-400">
            animate-none
          </td>
        ...
        <tr>
          <td translate="no" className="py-2 pr-2 font-mono font-bold text-xs leading-6 text-teal-500 whitespace-nowrap border-t border-slate-100 dark:border-slate-400/10 dark:text-teal-400">
            animate-spin
          </td>
...
<Example>
  <div class="flex items-center justify-center">
    <span class="relative inline-flex">
      <button type="button" class="inline-flex items-center px-4 py-2 font-semibold leading-6 text-sm shadow rounded-md text-teal-500 bg-white dark:bg-slate-800 transition ease-in-out duration-150 cursor-not-allowed ring-1 ring-slate-900/10 dark:ring-slate-200/20" disabled>
        Transactions
      </button>
