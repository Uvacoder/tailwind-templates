...
<Example hint="Hover over this button to see the background color change">
  <div class="grid place-items-center">
    <button class="bg-teal-500 hover:bg-sky-700 px-5 py-2 text-sm leading-5 rounded-full font-semibold text-white">
      Save changes
    </button>
  </div>
</Example>
...
```html
<button class="bg-teal-500 **hover:bg-sky-700** ...">
  Save changes
</button>
```
  ...
  <div class="max-w-sm mx-auto bg-white shadow py-5 px-6">
    <form>
      ...
      <div class="mt-6 text-right">
        <button class="bg-teal-500 hover:bg-sky-700 px-5 py-2.5 text-sm leading-5 rounded-md font-semibold text-white">
          Save changes
        </button>
      </div>
    </form>
...
<Example hint="Hover over the card to see both text elements change color">
  <a href="#" class="group block max-w-xs mx-auto rounded-lg p-4 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-teal-500 hover:ring-sky-500">
...
```html
<a href="#" class="**group** block max-w-xs mx-auto rounded-lg p-6 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-teal-500 hover:ring-sky-500">
  <div class="flex items-center space-x-3">
...
<Example p="none">
  <div class="px-4">
    <fieldset class="mx-auto max-w-md bg-white p-8 text-sm shadow">
      ...
      <input id="draft" class="peer/draft form-radio mr-2 mb-0.5 border-slate-300 text-teal-400 focus:ring-sky-300" type="radio" name="status" checked /><label class="peer-checked/draft:text-teal-500 font-medium" for="draft">Draft</label> <input id="published" class="peer/published form-radio mr-2 mb-0.5 ml-4 border-slate-300 text-teal-400 focus:ring-sky-300" type="radio" name="status" /><label class="peer-checked/published:text-teal-500 font-medium" for="published">Published</label>
