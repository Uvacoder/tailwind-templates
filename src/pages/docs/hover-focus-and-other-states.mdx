...
For example, to apply the `bg-teal-700` class on hover, use the `hover:bg-teal-700` class:

<Example hint="Hover over this button to see the background color change">
  <div class="grid place-items-center">
    <button class="bg-teal-500 hover:bg-teal-700 px-5 py-2 text-sm leading-5 rounded-full font-semibold text-white">
      Save changes
    </button>
  </div>
</Example>
...
```html
<button class="bg-teal-500 **hover:bg-teal-700** ...">
  Save changes
</button>
```
...
Notice how `hover:bg-teal-700` _only_ defines styles for the `:hover` state? It does nothing by default, but as soon as you hover over an element with that class, the background color will change to `teal-700`.
  ...
  <div class="max-w-sm mx-auto bg-white shadow py-5 px-6">
    <form>
      ...
      <div class="mt-6 text-right">
        <button class="bg-teal-500 hover:bg-teal-700 px-5 py-2.5 text-sm leading-5 rounded-md font-semibold text-white">
          Save changes
        </button>
      </div>
    </form>
...
<Example hint="Hover over the card to see both text elements change color">
  <a href="#" class="group block max-w-xs mx-auto rounded-lg p-4 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-teal-500 hover:ring-teal-500">
    <div class="flex items-center space-x-3">
      <svg class="h-6 w-6 stroke-teal-500 group-hover:stroke-white" fill="none" viewBox="0 0 24 24">
...
```html
<a href="#" class="**group** block max-w-xs mx-auto rounded-lg p-6 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-teal-500 hover:ring-teal-500">
  <div class="flex items-center space-x-3">
    <svg class="h-6 w-6 stroke-teal-500 **group-hover:stroke-white**" fill="none" viewBox="0 0 24 24"><!-- ... --></svg>
...
<Example p="none">
  <div class="px-4">
    <fieldset class="mx-auto max-w-md bg-white p-8 text-sm shadow">
      ...
      <input id="draft" class="peer/draft form-radio mr-2 mb-0.5 border-slate-300 text-teal-400 focus:ring-teal-300" type="radio" name="status" checked /><label class="peer-checked/draft:text-teal-500 font-medium" for="draft">Draft</label> <input id="published" class="peer/published form-radio mr-2 mb-0.5 ml-4 border-slate-300 text-teal-400 focus:ring-teal-300" type="radio" name="status" /><label class="peer-checked/published:text-teal-500 font-medium" for="published">Published</label>
...
<fieldset>
  ...
  <label for="draft" class="**peer-checked/draft:text-teal-500**">Draft</label>

  <input id="published" class="**peer/published**" type="radio" name="status" />
  <label for="published" class="**peer-checked/published:text-teal-500**">Published</label>
  ...
  <div class="max-w-sm mx-auto bg-white shadow pt-6 pb-5 px-6">
    <form>
      <label class="block">
        ...
        <input type="email" name="email" id="email" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-teal-500 focus:ring-teal-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="you@example.com" />
      </label>
    </form>
  </div>
</Example>
...
<label class="block">
  ...
  <input type="email" name="email" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-teal-500 focus:ring-teal-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="you@example.com" />
</label>
```
  ...
  <div class="max-w-sm mx-auto">
    <form>
      <label class="relative block">
        ...
        <input type="text" name="search" class="block bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm placeholder:italic placeholder:text-slate-400 focus:outline-none focus:border-teal-500 focus:ring-teal-500 focus:ring-1 sm:text-sm" placeholder="Search for anything..."
        />
      </label>
    </form>
  </div>
...
<label class="relative block">
  ...
  <input class="**placeholder:italic** **placeholder:text-slate-400** block bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-teal-500 focus:ring-teal-500 focus:ring-1 sm:text-sm" placeholder="Search for anything..." type="text" name="search"/>
</label>
```
...
<Example p="none">
  <div class="px-6">
    <div class="max-w-sm mx-auto bg-white shadow py-8 px-8 dark:bg-slate-800">
      ...
      <ul role="list" class="mt-3 list-disc pl-5 space-y-3 text-slate-500 marker:text-teal-400 dark:text-slate-400">
...
```html
<ul role="list" class="**marker:text-teal-400** list-disc pl-5 space-y-3 text-slate-500" dark-class="**marker:text-teal-400** list-disc pl-5 space-y-3 text-slate-400">
  <li>5 cups chopped Porcini mushrooms</li>
  <li>1/2 cup of olive oil</li>
  <li>3lb of celery</li>
</ul>
  ...
  <div class="max-w-sm mx-auto bg-white shadow pt-6 pb-4 px-6">
    <form>
      <div>
        ...
        <div class="mt-1">
          <input type="text" name="contrast-example" id="contrast-example" class="px-3 py-2 bg-white border shadow-sm border-slate-200 placeholder-slate-400 focus:outline-none focus:border-teal-500 focus:ring-teal-500 block w-full rounded-md sm:text-sm focus:ring-1 contrast-more:border-slate-400 contrast-more:placeholder-slate-500"  placeholder="000-00-0000" />
...
For example, to apply the `bg-teal-700` class when the `aria-checked` attribute is set to `true`, use the `aria-checked:bg-teal-700` class:

```html
<div aria-checked="true" class="bg-gray-600 **aria-checked:bg-teal-700**">
  <!-- ... -->
</div>
```
...
```html
<input class="**valid:border-teal-500** ..." />
```
...
```html
<input min="1" max="5" class="**in-range:border-teal-500** ..." />
```
