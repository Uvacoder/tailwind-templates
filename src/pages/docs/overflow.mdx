...
<Example p="none">
  <div class="mx-4 bg-white dark:bg-slate-800 shadow-xl overflow-hidden">
    <div class="overflow-scroll grid grid-cols-[70px,repeat(7,150px)] grid-rows-[auto,repeat(16,50px)] max-h-[350px]">
      ...
      <!-- Calendar contents -->
      <div class="row-start-[2] col-start-3 row-span-4 bg-blue-400/20 dark:bg-teal-600/50 border border-blue-700/10 dark:border-teal-500 rounded-lg m-1 p-1 flex flex-col">
        <span class="text-xs text-blue-600 dark:text-teal-100">5 AM</span>
        <span class="text-xs font-medium text-blue-600 dark:text-teal-100">Flight to vancouver</span>
        <span class="text-xs text-blue-600 dark:text-teal-100">Toronto YYZ</span>
      </div>
