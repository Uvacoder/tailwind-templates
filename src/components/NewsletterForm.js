  ...
  return (
    <form action={action} method="post" className="flex flex-wrap -mx-2">
      ...
      <div className="px-2 grow flex mt-3">
        <button
          type="submit"
          className="bg-teal-500 flex-auto shadow text-white rounded-md text-sm border-y border-transparent py-2 font-semibold px-3 hover:bg-sky-600 dark:hover:bg-teal-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-300 dark:focus:ring-offset-slate-900 dark:focus:ring-sky-700"
        >
          Subscribe
        </button>
      </div>
