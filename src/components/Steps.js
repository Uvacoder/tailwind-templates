  ...
  return (
    <div className="relative flex -mr-2">
      ...
      <Transition
        ...
        leaveTo="opacity-0"
      >
        <Alert className="relative bg-teal-500 text-white font-mono text-[0.625rem] leading-6 font-medium px-1.5 rounded-lg">
          Copied
          <svg
            aria-hidden="true"
            width="16"
            height="6"
            viewBox="0 0 16 6"
            className="text-teal-500 absolute top-full left-1/2 -mt-px -ml-2"
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
