  ...
  return (
    <Component
      className={clsx('group flex whitespace-pre-wrap', className, {
        '-ml-4 pl-4': !hidden,
        'mb-2 text-sm leading-6 text-teal-500 font-semibold tracking-normal dark:text-teal-400':
    ...
    >
      ...
      {badge && (
        <span className="ml-3 inline-flex items-center px-3 py-1 rounded-full text-sm font-medium leading-4 bg-teal-150 text-teal-900">
          {badge}
        </span>
      )}
    </Component>
